...
const gammaProxyAbi = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "_deltaScale", type: "uint256" }],
    name: "DeltaScaleSet",
    type: "event"
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "_depositDelta", type: "uint256" }],
    name: "DepositDeltaSet",
    type: "event"
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "address", name: "pos", type: "address" }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "address", name: "pos", type: "address" },
      { indexed: false, internalType: "address[]", name: "listed", type: "address[]" }
    ],
    name: "ListAppended",
    type: "event"
  },
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: "address", name: "pos", type: "address" },
      { indexed: false, internalType: "uint256", name: "_priceThreshold", type: "uint256" }
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "_priceThreshold", type: "uint256" }],
    name: "PriceThresholdSet",
    type: "event"
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint32", name: "_twapInterval", type: "uint32" }],
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: "address", name: "pos", type: "address" },
      { indexed: false, internalType: "bool", name: "twapOverride", type: "bool" },
      { indexed: false, internalType: "uint32", name: "_twapInterval", type: "uint32" }
    ],
    name: "TwapOverrideSet",
    type: "event"
  },
  { anonymous: false, inputs: [], name: "TwapToggled", type: "event" },
  {
    inputs: [
  ...
  { inputs: [], name: "deltaScale", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  {
    inputs: [
  ...
  { inputs: [], name: "depositDelta", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  {
    inputs: [
      { internalType: "address", name: "pos", type: "address" },
      { internalType: "address", name: "token", type: "address" },
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "pos", type: "address" },
      { internalType: "address", name: "i", type: "address" }
    ],
    name: "getListed",
    outputs: [{ internalType: "bool", name: "", type: "bool" }],
    stateMutability: "view",
  ...
  {
    inputs: [{ internalType: "uint256", name: "_deltaScale", type: "uint256" }],
    name: "setDeltaScale",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function"
  ...
  {
    inputs: [{ internalType: "uint256", name: "_depositDelta", type: "uint256" }],
  ...
  {
    inputs: [{ internalType: "uint256", name: "_priceThreshold", type: "uint256" }],
  ...
  { inputs: [], name: "toggleTwap", outputs: [], stateMutability: "nonpayable", type: "function" },
  {
    inputs: [{ internalType: "address", name: "newOwner", type: "address" }],
  ...
  { inputs: [], name: "twapCheck", outputs: [{ internalType: "bool", name: "", type: "bool" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "twapInterval", outputs: [{ internalType: "uint32", name: "", type: "uint32" }], stateMutability: "view", type: "function" }
];
...
const hypervisorAbi = [
  ...
  { inputs: [], name: "baseLower", outputs: [{ internalType: "int24", name: "", type: "int24" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "baseUpper", outputs: [{ internalType: "int24", name: "", type: "int24" }], stateMutability: "view", type: "function" },
  {
  ...
  { inputs: [], name: "currentTick", outputs: [{ internalType: "int24", name: "tick", type: "int24" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "decimals", outputs: [{ internalType: "uint8", name: "", type: "uint8" }], stateMutability: "view", type: "function" },
  {
    inputs: [
      { internalType: "address", name: "spender", type: "address" },
  ...
  { inputs: [], name: "deposit0Max", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "deposit1Max", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "directDeposit", outputs: [{ internalType: "bool", name: "", type: "bool" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "fee", outputs: [{ internalType: "uint8", name: "", type: "uint8" }], stateMutability: "view", type: "function" },
  ...
  { inputs: [], name: "limitLower", outputs: [{ internalType: "int24", name: "", type: "int24" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "limitUpper", outputs: [{ internalType: "int24", name: "", type: "int24" }], stateMutability: "view", type: "function" },
  {
    inputs: [],
    name: "maxTotalSupply",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
...
module.exports = { nonFungiblePositionAbi, algebraRouterAbi, CLRouterAbi, gammaProxyAbi, hypervisorAbi, lpABI, erc721Abi, erc20Abi, snapshotAbi };
