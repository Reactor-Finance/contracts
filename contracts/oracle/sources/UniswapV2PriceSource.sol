...
import "../interfaces/IUniswapRouters.sol";
import "@openzeppelin/contracts/token/ERC20/ERC20.sol";

contract UniswapV2PriceSource is PriceSource {
    ...
    constructor(
        ...
        address _usdc,
        address _weth
    ) PriceSource("UniswapV2", _usdt, _usdc, _weth) {
        factory = _factory;
        router02 = _router02;
    }
    ...
    function _deriveAmountOut(
        ...
        uint256[] memory amounts = router02.getAmountsOut(_amountIn, path);
