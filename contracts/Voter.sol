...
contract Voter is IVoter, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    address public minter; // minter mints $rct each epoch
    ...
    mapping(address => uint256) public claimable; // gauge    => claimable $rct
    ...
    /// @param  _minter the minter of $rct
    ...
    /// @dev    this function track the gauge index to emit the correct $rct amount after the distribution
