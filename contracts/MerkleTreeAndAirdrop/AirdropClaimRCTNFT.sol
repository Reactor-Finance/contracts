...
contract AirdropClaimRCTNFT is ReentrancyGuard {
    ...
    /// @notice claim the given amount and send to _to. Checks are done by merkle tree contract. (eg.: 40% veRCT 60% $RCT)
