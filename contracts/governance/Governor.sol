...
abstract contract L2Governor is Context, ERC165, EIP712, IGovernor, IERC721Receiver, IERC1155Receiver {
     ...
     *
     * Note: Should be overridden by specific implementations to use an appropriate value, RCT
    ...
    /**
     * @dev Internal vote casting mechanism: Check that RCT vote is pending, that it has not been cast yet, retrieve
     * voting weight using {IGovernor-getVotes} and call RCT {_countVote} internal function. Uses RCT _defaultParams().
     *
...
abstract contract L2GovernorVotesQuorumFraction is L2GovernorVotes {
    ...
    /**
     * @dev Initialize quorum as a fraction of RCT token's total supply.
     *
